...
export type Company = { id: string; name: string; country: string; industry: string; website: string | null; default_currency: string };
export type Rfq = {
  id: string; company_id: string; reference: string; buyer_name: string; source_type: string;
  source_filename: string | null; document_id: string | null; status: string; notes: string | null;
...
export type Database = {
  public: {
    Tables: {
      companies: Table<Company, Omit<Company, "id"> & { id?: string }, Partial<Company>>;
      ...
      rfqs: Table<Rfq, Omit<Rfq, "id" | "created_at" | "updated_at"> & { id?: string; created_at?: string; updated_at?: string }, Partial<Rfq>>;
      rfq_items: Table<RfqItem, Omit<RfqItem, "id" | "created_at"> & { id?: string; created_at?: string }, Partial<RfqItem>>;
      quotations: Table<Quotation, Omit<Quotation, "id" | "created_at" | "updated_at"> & { id?: string }, Partial<Quotation>>;
